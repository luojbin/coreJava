...
public class TempTest {
    ...
    class User2 {
        ...
        public User2 getFromDemoUser(DemoUser input) {
            User2 user2 = new User2();
            user2.setName(input.getName());
            user2.setAddress(input.getAddress());
            user2.setAge(input.getAge());
            user2.setEmail(input.getEmail());
            return user2;
